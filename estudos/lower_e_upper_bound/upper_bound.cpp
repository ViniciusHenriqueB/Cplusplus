// Faz uma busca binária e retorna um iterador para o primeiro elemento que que seja maior que a chave passada
...
int main() {
    ...
    if (it != vec.end()) {                            
        cout << "O upper_bound de 4 esta no indice: " << (it - vec.begin()) << endl;  // 5
    } else {
